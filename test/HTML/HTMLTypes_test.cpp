...
TEST(HTML_HTMLTypes, Attribute) {
  EXPECT_EQ("\"name\":\"value\"", static_cast<const std::stringstream&>(std::stringstream() << Attribute(U"name", U"value")).str());
...
TEST(HTML_HTMLTypes, ASCIIAttribute) {
  EXPECT_EQ("\"name\":\"value\"", static_cast<const std::stringstream&>(std::stringstream() << ASCIIAttribute("name", "value")).str());
...
TEST(HTML_HTMLTypes, ContentType) {
  EXPECT_EQ("CharEncoding::UTF_8:Confidence::CERTAIN",
            static_cast<const std::stringstream&>(std::stringstream() << ContentType(CharEncoding::UTF_8, Confidence::CERTAIN)).str());
  EXPECT_EQ("CharEncoding::UTF_8", static_cast<const std::stringstream&>(std::stringstream() << CharEncoding::UTF_8).str());
  EXPECT_EQ("CharEncoding::UTF_16_BE", static_cast<const std::stringstream&>(std::stringstream() << CharEncoding::UTF_16_BE).str());
  EXPECT_EQ("CharEncoding::UTF_16_LE", static_cast<const std::stringstream&>(std::stringstream() << CharEncoding::UTF_16_LE).str());
  EXPECT_EQ("CharEncoding::UNKNOWN", static_cast<const std::stringstream&>(std::stringstream() << CharEncoding::UNKNOWN).str());
  EXPECT_EQ("CharEncoding::NULL_ENC", static_cast<const std::stringstream&>(std::stringstream() << CharEncoding::NULL_ENC).str());
  EXPECT_EQ("Confidence::IRRELEVANT", static_cast<const std::stringstream&>(std::stringstream() << Confidence::IRRELEVANT).str());
  EXPECT_EQ("Confidence::TENTATIVE", static_cast<const std::stringstream&>(std::stringstream() << Confidence::TENTATIVE).str());
  EXPECT_EQ("Confidence::CERTAIN", static_cast<const std::stringstream&>(std::stringstream() << Confidence::CERTAIN).str());
