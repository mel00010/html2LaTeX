...
::testing::AssertionResult AssertState(__attribute__((unused)) const char* state_expr, const char* tokenizer_expr, const State& state,
                                       const Tokenizer& tokenizer) {
  if (tokenizer.getCurrentState() == state) return ::testing::AssertionSuccess();

  return ::testing::AssertionFailure() << tokenizer_expr << " is not in state " << state << ".  \n\n"
                                       << "Actual state:  " << tokenizer.getCurrentState();
}
::testing::AssertionResult AssertParseError(__attribute__((unused)) const char* state_expr, const char* tokenizer_expr, const State& state,
                                            const Tokenizer& tokenizer) {
  if (tokenizer.getCurrentState() == state) return ::testing::AssertionSuccess();
...
TEST(HTML_Parse_Tokenization_States, dataState) {
  ...
  TEST_STATE_1(U"\U0001f34c"s, DATA, DATA, CharacterToken(U'\U0001f34c'));
}
...
TEST(HTML_Parse_Tokenization_States, RCDATAState) {
  ...
  TEST_STATE_1(U"\U0001f34c"s, RCDATA, RCDATA, CharacterToken(U'\U0001f34c'));
}
...
TEST(HTML_Parse_Tokenization_States, RAWTEXTState) {
  ...
  TEST_STATE_1(U"\U0001f34c"s, RAWTEXT, RAWTEXT, CharacterToken(U'\U0001f34c'));
}
...
TEST(HTML_Parse_Tokenization_States, scriptDataState) {
  ...
  TEST_STATE_1(U"\U0001f34c"s, SCRIPT_DATA, SCRIPT_DATA, CharacterToken(U'\U0001f34c'));
}
...
TEST(HTML_Parse_Tokenization_States, plainTextState) {
  ...
  TEST_STATE_1(U"\U0001f34c"s, PLAINTEXT, PLAINTEXT, CharacterToken(U'\U0001f34c'));
}
