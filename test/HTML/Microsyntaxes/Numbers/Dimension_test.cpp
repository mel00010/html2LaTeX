...
TEST(HTML_Microsyntaxes_Numbers_Dimension, isDimension) {
	...
	EXPECT_FALSE(isDimension("0.1.1"));
...
TEST(HTML_Microsyntaxes_Numbers_Dimension, parseDimension) {
	...
	EXPECT_THROW(parseDimension("01.a"), parseException);
	EXPECT_THROW(parseDimension("01.a&"), parseException);
	EXPECT_THROW(parseDimension("0.1.1"), parseException);
	...
	EXPECT_THROW(parseDimension("."), parseException);
	EXPECT_THROW(parseDimension("1.0e10"), parseException);
