 ...
 *******************************************************************************/
#ifndef SRC_HTML_DOM_TRACKEVENT_HPP_
#define SRC_HTML_DOM_TRACKEVENT_HPP_
...
class TrackEvent: public Event {
	public:
		TrackEvent(DOMString type);
		TrackEvent(DOMString type, TrackEventInit eventInitDict);
...
#endif /* SRC_HTML_DOM_TRACKEVENT_HPP_ */
