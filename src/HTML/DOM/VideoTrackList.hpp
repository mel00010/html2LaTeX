 ...
 *******************************************************************************/
#ifndef SRC_HTML_DOM_VIDEOTRACKLIST_HPP_
#define SRC_HTML_DOM_VIDEOTRACKLIST_HPP_
...
class VideoTrackList: public EventTarget {
	public:
		...
		std::optional<VideoTrack> getTrackById(DOMString id);
...
#endif /* SRC_HTML_DOM_VIDEOTRACKLIST_HPP_ */
