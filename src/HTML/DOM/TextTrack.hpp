 ...
 *******************************************************************************/
#ifndef SRC_HTML_DOM_TEXTTRACK_HPP_
#define SRC_HTML_DOM_TEXTTRACK_HPP_
...
class TextTrack: public EventTarget {
	public:
		...
		const DOMString language;

		const DOMString id;
		const DOMString inBandMetadataTrackDispatchType;
...
#endif /* SRC_HTML_DOM_TEXTTRACK_HPP_ */
