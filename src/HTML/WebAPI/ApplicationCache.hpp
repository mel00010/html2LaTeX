 ...
 *******************************************************************************/
#ifndef SRC_HTML_WEBAPI_APPLICATIONCACHE_HPP_
#define SRC_HTML_WEBAPI_APPLICATIONCACHE_HPP_
...
class ApplicationCache: public DOM::EventTarget {
	public:
		// update status
...
#endif /* SRC_HTML_WEBAPI_APPLICATIONCACHE_HPP_ */
