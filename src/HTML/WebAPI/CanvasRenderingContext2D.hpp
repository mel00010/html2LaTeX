...
class CanvasCompositing {
	public:
		...
		DOM::DOMString globalCompositeOperation; // (default source-over)
};
...
class CanvasFillStrokeStyles {
	public:
		...
		std::variant<DOM::DOMString, CanvasGradient, CanvasPattern> strokeStyle; // (default black)
		std::variant<DOM::DOMString, CanvasGradient, CanvasPattern> fillStyle; // (default black)
		CanvasGradient createLinearGradient(double x0, double y0, double x1, double y1);
		CanvasGradient createRadialGradient(double x0, double y0, double r0, double x1, double y1, double r1);
		std::optional<CanvasPattern> createPattern(CanvasImageSource image, DOM::DOMString repetition);
...
class CanvasShadowStyles {
	public:
		...
		DOM::DOMString shadowColor; // (default transparent black)
};
...
class CanvasFilters {
	public:
		// filters
		DOM::DOMString filter; // (default "none")
};
...
class CanvasText {
	public:
		...
		void fillText(DOM::DOMString text, double x, double y, std::optional<double> maxWidth);
		void strokeText(DOM::DOMString text, double x, double y, std::optional<double> maxWidth);
...
class CanvasTextDrawingStyles {
	public:
		// text
		DOM::DOMString font; // (default 10px sans-serif)
...
class CanvasGradient {
	public:
		// opaque object
		void addColorStop(double offset, DOM::DOMString color);
};
...
#endif /* SRC_HTML_WEBAPI_CANVASRENDERINGCONTEXT2D_HPP_ */
