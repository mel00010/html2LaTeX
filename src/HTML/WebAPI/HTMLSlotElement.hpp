...
class HTMLSlotElement : public HTMLElement {
  DOM::DOMString name;
  std::vector<DOM::Node> assignedNodes(std::optional<AssignedNodesOptions> options);
  std::vector<DOM::Element> assignedElements(std::optional<AssignedNodesOptions> options);
};
