	...
	if(DOXYGEN_FOUND)
		if(NOT TARGET ${DOC_TARGET})
			...
			if(NOT IN_DASHBOARD_SCRIPT)
				add_custom_target(${DOC_TARGET} DEPENDS DOXYGEN_TARGET)
				...
				add_custom_target(${DOC_TARGET} ALL DEPENDS DOXYGEN_TARGET)
			endif()
		endif()
...
#			"${OUTPUT_DIRECTORY}/xml")
		...
		if(NOT NO_DOCBOOK)
			set(GENERATE_DOCBOOK YES)
		else()
			set(GENERATE_DOCBOOK NO)
		endif()
		...
		# for info on this variableLATEX_COMPILER
